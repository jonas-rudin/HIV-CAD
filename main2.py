...
if __name__ == '__main__':
    for c in clusters:
        ...
        for repetition in range(repetitions):
            ...
            one_hot.encode_sam(c)

            n_clusters = c  # TODO revert config[data]['n_clusters']
            ...
            print(f'{ColorCoding.OKGREEN}Initialize KMeans{ColorCoding.ENDC} for ' + str(
                n_clusters) + ' clusters (' + str(
                kmeans_rep) + ' times)')
            ...
            _, min_indexes, cpr_reversed = performance.correct_phasing_rate(consensus_sequences,
                                                                            'reverse_after_training',
                                                                            reverse=True)
